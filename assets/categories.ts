export default [
  {
    id: 1,
    name: 'Süper İkili',
    src: 'https://market-product-images-cdn.getirapi.com/category/69e45d48-3d6b-41a2-a475-54aa541055c8.png',
    subCategories: ["Dizinin ikilileri", "Maçın ikilileri", 'hazır yemek ikilileri']

  },

  {
    id:2 ,
    name: 'Yılın Yıldızları',
    src: 'https://market-product-images-cdn.getirapi.com/category/744b4569-40eb-4b06-a2b8-a7322f8aa60e.jpg',
    subCategories: ['Atıştırmalık', 'Su&İçecek', 'Dondurma', 'Süt Ürünleri', 'Kahvaltılık', 'Şarküteri', 'Temel Gıda', 'Ev Bakım']
...

  {
    id :3 ,
    name :'Mor İndirim',
    src :'https://market-product-images-cdn.getirapi.com/category/875d8363-34b3-44e8-9e20-df222d3e3c61.png',
    subCategories:['sepette %40', '2.si %80', 'sepette %35', '2.si %70', '2.si %60','sepette %30', 'sepette %25', 'sepette %20']
  
  },
  {
    id: "4",
    name: "İndirimler",
    src: "https://market-product-images-cdn.getirapi.com/category/ddb05de4-920a-4069-ac70-c79c4d3025cd.png",
